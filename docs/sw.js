...
const VERSION = '1787718833184';
const CACHE_COQUILLE = `coquille-${VERSION}`;
const CACHE_TEXTES = 'aelf-textes-v1';
const PRECACHE = ["./","./assets/index-CbCYLCB9.js","./assets/index-y7Z6OZjI.css","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/icon-maskable.svg","./icons/icon.svg","./index.html","./manifest.webmanifest"];
